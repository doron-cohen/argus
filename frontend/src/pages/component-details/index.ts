    ...
    return html`
      ...
      >
        <a
          slot="actions"
          href="/components"
          class="u-inline-flex u-items-center u-px-3 u-py-2 u-border u-border-gray-200 u-rounded-md u-shadow-sm u-text-sm u-font-medium u-text-gray-700 u-bg-white hover:u-bg-gray-50"
